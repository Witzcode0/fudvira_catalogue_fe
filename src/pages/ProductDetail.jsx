...
import { textConverter } from "../utils/textUtils";
        ...
        <div className="pd-info">
          ...
          {product.variations?.length > 0 && (
            ...
            <div className="pd-variations">
              ...
              <div className="pd-variation-list">

                {product.variations.map((variation) => {

                  const label = `${Number(variation.quantity)}${variation.unit_symbol}`;

                  return (

                    <button
                      key={variation.id}
                      className={`pd-variation-btn ${
